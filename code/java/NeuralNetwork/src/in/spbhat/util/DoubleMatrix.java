...
public class DoubleMatrix {
    ...
    public static double[][] createRandom(int rows, int cols, Random generator) {
        return apply(create(rows, cols), x -> generator.nextDouble());
    }

    public static double[][] createRandom(int rows, int cols, double mean, double sigma, Random generator) {
